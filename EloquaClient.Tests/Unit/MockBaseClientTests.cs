...
{
    [TestClass]
    public class MockBaseClientTests
    {
        ...
        public void MyTestMethod()
        {
            ...
            restClient.Setup(o => o.Execute<Contact>(It.IsAny<IRestRequest>())).Returns(restResponse.Object);

            var client = new Client(new EloquaRestClient(restClient.Object));

            //Act
            var contact = client.Data.Contact.Get(1, Depth.Complete);
